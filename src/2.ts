...
const TanyaSolova = new Employee("Anya", "Content", 500);
console.log(TanyaSolova.getEmployeeDetails());
...
const LeshaDragunov = new Manager("Lesha", "Content", 500);
console.log(LeshaDragunov.getEmployeeDetails());
export {};
